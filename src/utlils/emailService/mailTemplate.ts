export const RegisterEmailTemplate =  `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional //EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><!--[if IE]>
   ...
   <html style='margin: 0;padding: 0;' xmlns='http://www.w3.org/1999/xhtml'>
      ...
      <body class='full-padding' style='margin: 0;padding: 0;-webkit-text-size-adjust: 100%;'>
         <div class='wrapper' style='min-width: 320px;background-color: #f5f7fa;' lang='x-wrapper'>
            ...
            <div class='layout one-col fixed-width' style='Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 173000px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word; display: flex;'>
               <div class='layout__inner' style='border-collapse: collapse;display: table;width: 100%;background-color: #be9788;' lang='x-layout__inner'>
                  <div class='column' style='text-align: left;color: #be9788 !important;font-size: 14px;line-height: 21px;font-family: "Open Sans",sans-serif;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);'>
                     <div style='Margin-left: 20px; justify-content: space-between; Margin-right: 20px;Margin-top: 24px;
    Margin-bottom: 24px;display: flex;'>
                        <h1 class='size-48' style='Margin-top: 10px;margin-left: 12px;margin-left: 15px;Margin-bottom: 0;font-style: normal;font-weight: normal;color: black;font-size: 36px;line-height: 43px;font-family: bitter,georgia,serif;text-align: center;' lang='x-size-48'><span class='font-bitter'><font color='#ffffff'><strong>Trident Builders</strong></font></span></h1>
                     </div>
                  </div>
               </div>
            </div>
               ...
               <div class='layout__inner' style='border-collapse: collapse;display: table;width: 100%;background-color: #ffffff;' lang='x-layout__inner' emb-background-style>
                  <div class='column' style='text-align: left;color: #60666d;font-size: 14px;line-height: 21px;font-family: "Open Sans",sans-serif;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);'>
                     ...
                     <div style='Margin-left: 20px;Margin-right: 20px;'>
                        <h2 class='size-24' style='Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: black;font-size: 20px;line-height: 28px;text-align: center;' lang='x-size-24'><strong>Registration Successful</strong></h2>
                        <p style='Margin-top: 16px;Margin-bottom: 0;'><strong>Dear {values.name},</strong></p>
                        <p style='Margin-top: 20px;Margin-bottom: 20px;'><strong>Thanks for registration in with Poorvika Central Inventory. </strong></p>
                        <p style='Margin-top: 20px;Margin-bottom: 20px;'><strong>Please click the below button to sign in to your account.</strong></p>
                        <p style='Margin-top: 20px;Margin-bottom: 20px;'><strong>Sincerely,<br>The Poorvika - Central Inventory Team</strong></p>
                     </div>
                     <a href="https://dev-centralinventory.poorvika.com/reset-password?{values.email}">
                     <div style='Margin-left: 20px;Margin-right: 20px;'>
                        <div class='btn btn--flat btn--large' style='Margin-bottom: 20px;text-align: center;'>
                           <![if !mso]>
                           <p style="border-radius: 4px;display: inline-block;font-size: 14px;font-weight: bold;line-height: 24px;padding: 12px 24px;text-align: center;text-decoration: none !important;transition: opacity 0.1s ease-in;color: #fff;background-color: #be9788 !important;font-family: 'Open Sans', sans-serif;"> Sign In </p>
                           <![endif]>
                        </div>
                     </div>
                     </a>
...
<tr>
         ...
         <img style='overflow: hidden;position: fixed;visibility: hidden !important;display: block !important;height: 1px !important;width: 1px !important;border: 0 !important;margin: 0 !important;padding: 0 !important;' src='https://photobookworldwide.createsend1.com/t/d-o-dlldol-l/o.gif' width='1' height='1' border='0' alt=''>
         <div id='fb-root'></div>
   ...
   export const clientMail = `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional //EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><!--[if IE]>
   <html xmlns="http://www.w3.org/1999/xhtml" class="ie">
      <![endif]--><!--[if !IE]><!-->
      <html style='margin: 0;padding: 0;' xmlns='http://www.w3.org/1999/xhtml'>
         <!--<![endif]-->
                  ...
                  <div class='layout__inner' style='border-collapse: collapse;display: table;width: 100%;background-color: #ffffff;' lang='x-layout__inner' emb-background-style>
                     <div class='column' style='text-align: left;color: #60666d;font-size: 14px;line-height: 21px;font-family: "Open Sans",sans-serif;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);'>
                        ...
                        <div style='Margin-left: 20px;Margin-right: 20px;'>
                           ...
                           <p style='Margin-top: 16px;Margin-bottom: 0;'><strong>Dear {values.name},</strong></p>
                           <p style='Margin-top: 20px;Margin-bottom: 20px;'><strong>Thanks for relying on us ! </strong></p>
                           <p style='Margin-top: 20px;Margin-bottom: 20px;'><strong>Our team will approach you soon.</strong></p>
                           <p style='Margin-top: 20px;Margin-bottom: 20px;'><strong>Sincerely,<br>The Trident Builders Team</strong></p>
                        </div>
                        <a href="https://trident-builders.web.app/">
                        <div style='Margin-left: 20px;Margin-right: 20px;'>
                           <div class='btn btn--flat btn--large' style='Margin-bottom: 20px;text-align: center;'>
                              <![if !mso]>
                              <p style="border-radius: 4px;display: inline-block;font-size: 14px;font-weight: bold;line-height: 24px;padding: 12px 24px;text-align: center;text-decoration: none !important;transition: opacity 0.1s ease-in;color: #fff;background-color: #be9788 !important;font-family: 'Open Sans', sans-serif;"> Explore Us ! </p>
                              <![endif]>
                           </div>
                        </div>
                        </a>
